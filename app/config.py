...
def load_config():
    ...
    kommo_config = KommoConfig(
        ...
        field_ids={
            ...
            "conversion_value": int(
                os.getenv("KOMMO_CONVERSION_VALUE_FIELD_ID")
            ),
    ...
    google_ads_config = GoogleAdsConfig(
        ...
        conversion_action_ids={
            "kommo_message_received": os.getenv(
                "GOOGLE_ADS_MESSAGE_RECEIVED_CONVERSION_ACTION_ID"
            ),
            "appointment_made": os.getenv(
                "GOOGLE_ADS_APPOINTMENT_MADE_CONVERSION_ACTION_ID"
            ),
            "converted_lead": os.getenv(
                "GOOGLE_ADS_CONVERTED_LEAD_CONVERSION_ACTION_ID"
            ),
        },
    )
